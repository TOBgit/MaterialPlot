...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u"./Res/OpenCSV.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u"./Res/Axes.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"./Res/FamBubb.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"./Res/Family.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"./Res/MatBubb.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u"./Res/Select.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u"./Res/SelectionLine.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"./Res/ManageItem.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionManageItem.setIcon(icon9)
        self.actionCapture = QAction(MainWindow)
        self.actionCapture.setObjectName(u"actionCapture")
        icon10 = QIcon()
        icon10.addFile(u"./Res/Capture.png", QSize(), QIcon.Normal, QIcon.Off)
