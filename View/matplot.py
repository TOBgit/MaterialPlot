...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/logo/OpenCSV.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/logo/Axes.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/logo/Search.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/logo/FamBubb.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/logo/Family.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/logo/MatBubb.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/logo/Select.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/logo/SelectionLine.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/logo/ManageItem.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionManageItem.setIcon(icon9)
        self.actionCapture = QAction(MainWindow)
        self.actionCapture.setObjectName(u"actionCapture")
        icon10 = QIcon()
        icon10.addFile(u":/logo/Capture.svg", QSize(), QIcon.Normal, QIcon.Off)
